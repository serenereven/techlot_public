...
class TestSyncVehicle:
    ...
    def test_creates_vehicle(self, MockClient):
    ...
    @patch("core.services.bitrix.sync.BitrixCatalogClient")
    def test_brand_resolved(self, MockClient):
        MockClient.return_value = make_client()
        vehicle = sync_vehicle(1077)
    ...
    @patch("core.services.bitrix.sync.BitrixCatalogClient")
    def test_upsert_no_duplicate(self, MockClient):
        MockClient.return_value = make_client()
    ...
    @patch("core.services.bitrix.sync.BitrixCatalogClient")
    def test_returns_none_on_error(self, MockClient):
