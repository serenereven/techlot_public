...
SECURE_PROXY_SSL_HEADER = (
    ("HTTP_X_FORWARDED_PROTO", "https") if str_to_bool(os.getenv("DJANGO_SECURE_PROXY_SSL_HEADER", False)) else None
)

SECURE_SSL_REDIRECT = str_to_bool(os.getenv("DJANGO_SECURE_SSL_REDIRECT", False))

SESSION_COOKIE_SECURE = str_to_bool(os.getenv("DJANGO_SESSION_COOKIE_SECURE", False))

CSRF_COOKIE_SECURE = str_to_bool(os.getenv("DJANGO_CSRF_COOKIE_SECURE", False))
